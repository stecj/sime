 ...
 (function($) {
        ...
        $.fn.jTPS = function ( opt ) {
                ...
                $(this).data('tableSettings', $.extend({
                        perPages:               [5, 6, 10, 20, 50, 'TODO'],                              // the "show per page" selection
                        perPageText:            'Mostrar por página: ',                                               // text that appears before perPages links
                        ...
                        function () {
                                ...
                                $(this).bind('click', 
                                        function () { 
                                                ...
                                                $('tfoot .status', pT).html( 'Mostrar ' + ( cPos + 1 ) + ' - ' + ( cPos + ePos ) + ' de ' + rowCount + '' );
                                                clearSelection();
                                        }
                                );
                        }
                ...
                $('tfoot .status', this).html( 'Mostrar ' + ( cPos + 1 ) + ' - ' + ( cPos + ePos ) + ' de ' + rowCount );
